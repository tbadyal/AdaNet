...
package driver_functions_h is
  ...
  --  
   ...
   function make_cudaPitchedPtr
     (d : System.Address;
      p : stddef_h.size_t;
      xsz : stddef_h.size_t;
      ysz : stddef_h.size_t) return driver_types_h.cudaPitchedPtr;  -- /usr/local/cuda-8.0/include/driver_functions.h:79
   pragma Import (CPP, make_cudaPitchedPtr, "_ZL19make_cudaPitchedPtrPvmmm");
  ...
  --  
   ...
   function make_cudaPos
     (x : stddef_h.size_t;
      y : stddef_h.size_t;
      z : stddef_h.size_t) return driver_types_h.cudaPos;  -- /usr/local/cuda-8.0/include/driver_functions.h:106
   pragma Import (CPP, make_cudaPos, "_ZL12make_cudaPosmmm");
  ...
  --  
   ...
   function make_cudaExtent
     (w : stddef_h.size_t;
      h : stddef_h.size_t;
      d : stddef_h.size_t) return driver_types_h.cudaExtent;  -- /usr/local/cuda-8.0/include/driver_functions.h:132
   pragma Import (CPP, make_cudaExtent, "_ZL15make_cudaExtentmmm");
