...
package cuda_runtime_h is
  ...
  --  
   ...
   function cudaEventCreate (event : System.Address; flags : unsigned) return driver_types_h.cudaError_t;  -- /usr/local/cuda-8.0/include/cuda_runtime.h:260
   pragma Import (CPP, cudaEventCreate, "_ZL15cudaEventCreatePP10CUevent_stj");
  ...
  --  
   ...
   function cudaMallocHost
     (ptr : System.Address;
      ...
      flags : unsigned) return driver_types_h.cudaError_t;  -- /usr/local/cuda-8.0/include/cuda_runtime.h:323
   pragma Import (CPP, cudaMallocHost, "_ZL14cudaMallocHostPPvmj");
