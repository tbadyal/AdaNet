...
package x86_64_linux_gnu_bits_pthreadtypes_h is
  ...
  --   the attribute type is not exposed on purpose.   
   ...
   type pthread_cond_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_data : aliased anon_12;  -- /usr/include/x86_64-linux-gnu/bits/pthreadtypes.h:151
         when 1 =>
  ...
  --       binary compatibility.   
   ...
   type pthread_rwlock_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_data : aliased anon_15;  -- /usr/include/x86_64-linux-gnu/bits/pthreadtypes.h:200
         when 1 =>
