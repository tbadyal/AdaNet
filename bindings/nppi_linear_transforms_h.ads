...
package nppi_linear_transforms_h is
  ...
  --  
   ...
   function nppiMagnitude_32fc32f_C1R
     (pSrc : access constant nppdefs_h.Npp32fc;
      nSrcStep : int;
      pDst : access nppdefs_h.Npp32f;
      nDstStep : int;
      oSizeROI : nppdefs_h.NppiSize) return nppdefs_h.NppStatus;  -- /usr/local/cuda-8.0/include/nppi_linear_transforms.h:94
   pragma Import (C, nppiMagnitude_32fc32f_C1R, "nppiMagnitude_32fc32f_C1R");
  ...
  --  
   ...
   function nppiMagnitudeSqr_32fc32f_C1R
     (pSrc : access constant nppdefs_h.Npp32fc;
      nSrcStep : int;
      pDst : access nppdefs_h.Npp32f;
      nDstStep : int;
      oSizeROI : nppdefs_h.NppiSize) return nppdefs_h.NppStatus;  -- /usr/local/cuda-8.0/include/nppi_linear_transforms.h:117
   pragma Import (C, nppiMagnitudeSqr_32fc32f_C1R, "nppiMagnitudeSqr_32fc32f_C1R");

  --* @} image_fourier_transforms  
  --* @} image_linear_transforms  
  -- extern "C"  
end nppi_linear_transforms_h;
