  ...
  -- Macros for constructing status values.   
   ...
   type wait (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_wait_terminated : aliased anon_2;  -- /usr/include/x86_64-linux-gnu/bits/waitstatus.h:83
         when others =>
            uu_wait_stopped : aliased anon_3;  -- /usr/include/x86_64-linux-gnu/bits/waitstatus.h:96
      end case;
   end record;
   pragma Convention (C_Pass_By_Copy, wait);
   pragma Unchecked_Union (wait);  -- /usr/include/x86_64-linux-gnu/bits/waitstatus.h:66
