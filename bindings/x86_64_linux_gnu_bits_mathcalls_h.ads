...
package x86_64_linux_gnu_bits_mathcalls_h is
  ...
  --   is +Infinity, -1 if it is -Infinity.   
   ...
   function isinf (uu_value : double) return int;  -- /usr/include/x86_64-linux-gnu/bits/mathcalls.h:204
  ...
  -- Return nonzero if VALUE is not a number.   
   ...
   function isnan (uu_value : double) return int;  -- /usr/include/x86_64-linux-gnu/bits/mathcalls.h:241
