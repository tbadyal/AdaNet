...
package stdlib_h is
   ...
   --  arg-macro: procedure WEXITSTATUS __WEXITSTATUS (__WAIT_INT (status))
   --    __WEXITSTATUS (__WAIT_INT (status))
   --  arg-macro: procedure WTERMSIG __WTERMSIG (__WAIT_INT (status))
   --    __WTERMSIG (__WAIT_INT (status))
   --  arg-macro: procedure WSTOPSIG __WSTOPSIG (__WAIT_INT (status))
   --    __WSTOPSIG (__WAIT_INT (status))
   --  arg-macro: procedure WIFEXITED __WIFEXITED (__WAIT_INT (status))
   --    __WIFEXITED (__WAIT_INT (status))
   --  arg-macro: procedure WIFSIGNALED __WIFSIGNALED (__WAIT_INT (status))
   --    __WIFSIGNALED (__WAIT_INT (status))
   --  arg-macro: procedure WIFSTOPPED __WIFSTOPPED (__WAIT_INT (status))
   --    __WIFSTOPPED (__WAIT_INT (status))
   --  arg-macro: procedure WIFCONTINUED __WIFCONTINUED (__WAIT_INT (status))
