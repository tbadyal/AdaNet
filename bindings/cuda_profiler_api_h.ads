...
package cuda_profiler_api_h is
  ...
  --  
   ...
   function cudaProfilerInitialize
     (configFile : Interfaces.C.Strings.chars_ptr;
      outputFile : Interfaces.C.Strings.chars_ptr;
      outputMode : driver_types_h.cudaOutputMode_t) return driver_types_h.cudaError_t;  -- /usr/local/cuda-8.0/include/cuda_profiler_api.h:118
   pragma Import (C, cudaProfilerInitialize, "cudaProfilerInitialize");
  ...
  --  
   ...
   function cudaProfilerStart return driver_types_h.cudaError_t;  -- /usr/local/cuda-8.0/include/cuda_profiler_api.h:140
   pragma Import (C, cudaProfilerStart, "cudaProfilerStart");
  ...
  --  
   ...
   function cudaProfilerStop return driver_types_h.cudaError_t;  -- /usr/local/cuda-8.0/include/cuda_profiler_api.h:159
   pragma Import (C, cudaProfilerStop, "cudaProfilerStop");

  --* @}  
  -- END CUDART_PROFILER  
end cuda_profiler_api_h;
