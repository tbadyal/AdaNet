...
package cudaProfiler_h is
  ...
  --DEVICE_BUILTIN 
   type CUoutput_mode_enum is 
     (CU_OUT_KEY_VALUE_PAIR,
      CU_OUT_CSV);
   pragma Convention (C, CUoutput_mode_enum);  -- /usr/local/cuda-8.0/include/cudaProfiler.h:61

  --*< Output mode Key-Value pair format.  
  --*< Output mode Comma separated values format.  
   subtype CUoutput_mode is CUoutput_mode_enum;
