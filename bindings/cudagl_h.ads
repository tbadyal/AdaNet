...
package cudaGL_h is
   ...
   --  unsupported macro: cuGLCtxCreate cuGLCtxCreate_v2
   --  unsupported macro: cuGLMapBufferObject __CUDA_API_PTDS(cuGLMapBufferObject_v2)
   --  unsupported macro: cuGLMapBufferObjectAsync __CUDA_API_PTSZ(cuGLMapBufferObjectAsync_v2)
   --  unsupported macro: cuGLGetDevices cuGLGetDevices_v2
  ...
  --  
   ...
   subtype CUGLDeviceList_enum is unsigned;
   CU_GL_DEVICE_LIST_ALL : constant CUGLDeviceList_enum := 1;
   CU_GL_DEVICE_LIST_CURRENT_FRAME : constant CUGLDeviceList_enum := 2;
   CU_GL_DEVICE_LIST_NEXT_FRAME : constant CUGLDeviceList_enum := 3;  -- /usr/local/cuda-8.0/include/cudaGL.h:237

  --*< The CUDA devices for all GPUs used by the current OpenGL context  
  --*< The CUDA devices for the GPUs used by the current OpenGL context in its currently rendering frame  
  --*< The CUDA devices for the GPUs to be used by the current OpenGL context in the next frame  
   subtype CUGLDeviceList is CUGLDeviceList_enum;
  ...
  --* Flags to map or unmap a resource  
   type CUGLmap_flags_enum is 
     (CU_GL_MAP_RESOURCE_FLAGS_NONE,
      CU_GL_MAP_RESOURCE_FLAGS_READ_ONLY,
      CU_GL_MAP_RESOURCE_FLAGS_WRITE_DISCARD);
   pragma Convention (C, CUGLmap_flags_enum);  -- /usr/local/cuda-8.0/include/cudaGL.h:293

   subtype CUGLmap_flags is CUGLmap_flags_enum;
